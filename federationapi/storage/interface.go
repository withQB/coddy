...
type Database interface {
	...
	GetPendingEDUs(ctx context.Context, serverName spec.ServerName, limit int) (edus map[*receipt.Receipt]*xtools.EDU, err error)
	...
	GetNotaryKeys(ctx context.Context, serverName spec.ServerName, optKeyIDs []xtools.KeyID) ([]xtools.ServerKeys, error)
