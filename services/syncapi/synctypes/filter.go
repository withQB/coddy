...
// DefaultFilter returns the default filter used by the Coddy server if no filter is provided in
// the request
...
// DefaultEventFilter returns the default event filter used by the Coddy server if no filter is
...
// DefaultStateFilter returns the default state event filter used by the Coddy server if no filter
...
// DefaultFrameEventFilter returns the default frame event filter used by the Coddy server if no
