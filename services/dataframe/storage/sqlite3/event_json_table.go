...
const eventJSONSchema = `
  CREATE TABLE IF NOT EXISTS dataframe_event_json (
...
const insertEventJSONSQL = `
	INSERT OR REPLACE INTO dataframe_event_json (event_nid, event_json) VALUES ($1, $2)
`
...
const bulkSelectEventJSONSQL = `
	SELECT event_nid, event_json FROM dataframe_event_json
