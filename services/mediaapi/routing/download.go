...
func Download(
	...
	dReq := &downloadRequest{
		...
		Logger: xutil.GetLogger(req.Context()).WithFields(log.Fields{
			"Origin":  origin,
			"MediaID": mediaID,
		}),
...
func (r *downloadRequest) jsonErrorResponse(w http.ResponseWriter, res xutil.JSONResponse) {
...
func (r *downloadRequest) Validate() *xutil.JSONResponse {
...
func (r *downloadRequest) doDownload(
	...
	if mediaMetadata == nil {
		if r.MediaMetadata.Origin == cfg.Coddy.ServerName {
