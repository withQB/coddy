...
import (
	...
	uapi "github.com/withqb/coddy/services/userapi/api"
...
// is nil.
func LoginFromJSONReader(ctx context.Context, r io.Reader, useraccountAPI uapi.UserLoginAPI, userAPI UserInternalAPIForLogin, cfg *config.ClientAPI) (*Login, LoginCleanupFunc, *xutil.JSONResponse) {
	reqBytes, err := io.ReadAll(r)
	if err != nil {
		err := &xutil.JSONResponse{
