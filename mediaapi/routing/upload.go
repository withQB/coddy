...
import (
	...
	"github.com/withqb/coddy/mediaapi/fileutils"
	"github.com/withqb/coddy/mediaapi/storage"
	"github.com/withqb/coddy/mediaapi/thumbnailer"
	"github.com/withqb/coddy/mediaapi/types"
...
func parseAndValidateRequest(req *http.Request, cfg *config.MediaAPI, dev *userapi.Device) (*uploadRequest, *xutil.JSONResponse) {
	r := &uploadRequest{
		...
		Logger: xutil.GetLogger(req.Context()).WithField("Origin", cfg.Matrix.ServerName),
	}
