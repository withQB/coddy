...
import (
	...
	"github.com/withqb/coddy/servers/roomserver/storage/shared"
...
type Database interface {
	...
	AssignRoomNID(ctx context.Context, roomID spec.RoomID, roomVersion xtools.RoomVersion) (roomNID types.RoomNID, err error)
	...
	StoreEvent(ctx context.Context, event xtools.PDU, roomInfo *types.RoomInfo, eventTypeNID types.EventTypeNID, eventStateKeyNID types.EventStateKeyNID, authEventNIDs []types.EventNID, isRejected bool) (types.EventNID, types.StateAtEvent, error)
	...
	MembershipUpdater(ctx context.Context, roomID, targetUserID string, targetLocal bool, roomVersion xtools.RoomVersion) (*shared.MembershipUpdater, error)
	...
	GetBulkStateContent(ctx context.Context, roomIDs []string, tuples []xtools.StateKeyTuple, allowWildcards bool) ([]tables.StrippedEvent, error)
	...
	GetHistoryVisibilityState(ctx context.Context, roomInfo *types.RoomInfo, eventID string, domain string) ([]xtools.PDU, error)
	...
	GetOrCreateRoomInfo(ctx context.Context, event xtools.PDU) (*types.RoomInfo, error)
	GetRoomVersion(ctx context.Context, roomID string) (xtools.RoomVersion, error)
	...
	MaybeRedactEvent(
		ctx context.Context, roomInfo *types.RoomInfo, eventNID types.EventNID, event xtools.PDU, plResolver state.PowerLevelResolver, querier api.QuerySenderIDAPI,
