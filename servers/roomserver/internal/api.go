...
import (
	...
	"github.com/withqb/coddy/servers/roomserver/internal/input"
	"github.com/withqb/coddy/servers/roomserver/internal/perform"
	"github.com/withqb/coddy/servers/roomserver/internal/query"
	"github.com/withqb/coddy/servers/roomserver/producers"
...
func (r *RoomserverInternalAPI) SetFederationAPI(fsAPI fsAPI.RoomserverFederationAPI, keyRing *xtools.KeyRing) {
	r.fsAPI = fsAPI
	r.KeyRing = keyRing
...
func (r *RoomserverInternalAPI) DefaultRoomVersion() xtools.RoomVersion {
...
func (r *RoomserverInternalAPI) StateQuerier() xtools.StateQuerier {
...
func (r *RoomserverInternalAPI) SigningIdentityFor(ctx context.Context, roomID spec.RoomID, senderID spec.UserID) (fclient.SigningIdentity, error) {
	...
	if roomVersion == xtools.RoomVersionPseudoIDs {
...
func (r *RoomserverInternalAPI) AssignRoomNID(ctx context.Context, roomID spec.RoomID, roomVersion xtools.RoomVersion) (roomNID types.RoomNID, err error) {
