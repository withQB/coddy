...
const insertStateDataSQL = `
	INSERT INTO dataframe_state_block (state_block_hash, event_nids)
		VALUES ($1, $2)
...
const bulkSelectStateBlockEntriesSQL = "" +
	...
	" FROM dataframe_state_block WHERE state_block_nid IN ($1) ORDER BY state_block_nid ASC"
...
func (s *stateBlockStatements) BulkInsertStateData(
	...
	entries = entries[:xutil.SortAndUnique(entries)]
