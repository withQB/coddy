...
// https://github.com/withqb/synapse/blob/v0.19.2/synapse/handlers/room.py#L294
func InitialPowerLevelsContent(roomCreator string) (c xtools.PowerLevelContent) {
	c.Defaults()
