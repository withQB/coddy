...
import (
	...
	"github.com/withqb/coddy/apis/syncapi/storage/shared"
...
type DatabaseTransaction interface {
	...
	// GetStateEvent returns the Matrix state event of a given type for a given frame with a given state key
