...
func ToClientEvents(serverEvs []xtools.PDU, format ClientEventFormat, userIDForSender spec.UserIDForSender) []ClientEvent {
...
func ToClientEvent(se xtools.PDU, format ClientEventFormat, sender string, stateKey *string, unsigned spec.RawJSON) ClientEvent {
	ce := ClientEvent{
