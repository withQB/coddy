...
type Database interface {
	...
	StoreTransaction(ctx context.Context, txn xtools.Transaction) (*receipt.Receipt, error)
	...
	AssociateTransactionWithDestinations(ctx context.Context, destinations map[spec.UserID]struct{}, transactionID xtools.TransactionID, dbReceipt *receipt.Receipt) error
	...
	GetTransaction(ctx context.Context, userID spec.UserID) (*xtools.Transaction, *receipt.Receipt, error)
