...
type KeyDatabase interface {
	...
	DeleteDeviceKeys(ctx context.Context, userID string, deviceIDs []xtools.KeyID) error
	...
	CrossSigningSigsForTarget(ctx context.Context, originUserID, targetUserID string, targetKeyID xtools.KeyID) (types.CrossSigningSigMap, error)

	StoreCrossSigningKeysForUser(ctx context.Context, userID string, keyMap types.CrossSigningKeyMap) error
	StoreCrossSigningSigsForTarget(ctx context.Context, originUserID string, originKeyID xtools.KeyID, targetUserID string, targetKeyID xtools.KeyID, signature spec.Base64Bytes) error
