...
import (
	...
	fedapi "github.com/withqb/coddy/federationapi/api"
...
func (t *missingStateReq) processEventWithMissingState(
	ctx context.Context, e xtools.PDU, roomVersion xtools.RoomVersion,
...
func (t *missingStateReq) lookupResolvedStateBeforeEvent(ctx context.Context, e xtools.PDU, roomVersion xtools.RoomVersion) (*parsedRespState, error) {
...
// added into the mix.
func (t *missingStateReq) lookupStateAfterEvent(ctx context.Context, roomVersion xtools.RoomVersion, roomID, eventID string) (*parsedRespState, bool, error) {
...
// the server supports.
func (t *missingStateReq) lookupStateBeforeEvent(ctx context.Context, roomVersion xtools.RoomVersion, roomID, eventID string) (
	*parsedRespState, error) {
...
func (t *missingStateReq) resolveStatesAndCheck(ctx context.Context, roomVersion xtools.RoomVersion, states []*parsedRespState, backwardsExtremity xtools.PDU) (*parsedRespState, error) {
	...
	resolvedStateEvents, err := xtools.ResolveConflicts(
		roomVersion, xtools.ToPDUs(stateEventList), xtools.ToPDUs(authEventList), func(roomID spec.RoomID, senderID spec.SenderID) (*spec.UserID, error) {
...
func (t *missingStateReq) getMissingEvents(ctx context.Context, e xtools.PDU, roomVersion xtools.RoomVersion) (newEvents []xtools.PDU, isGapFilled, prevStateKnown bool, err error) {
	...
	for _, ev := range missingResp.Events.UntrustedEvents(roomVersion) {
		if err = xtools.VerifyEventSignatures(ctx, ev, t.keys, func(roomID spec.RoomID, senderID spec.SenderID) (*spec.UserID, error) {
			return t.inputer.Queryer.QueryUserIDForSender(ctx, roomID, senderID)
		}); err != nil {
			continue
		}
...
func (t *missingStateReq) lookupMissingStateViaState(
	ctx context.Context, roomID, eventID string, roomVersion xtools.RoomVersion,
...
func (t *missingStateReq) lookupMissingStateViaStateIDs(ctx context.Context, roomID, eventID string, roomVersion xtools.RoomVersion) (
	*parsedRespState, error) {
...
func (t *missingStateReq) lookupEvent(ctx context.Context, roomVersion xtools.RoomVersion, _, missingEventID string, localFirst bool) (xtools.PDU, error) {
