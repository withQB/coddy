...
func (u *RoomUpdater) RoomVersion() (version xtools.RoomVersion) {
...
func (u *RoomUpdater) Events(ctx context.Context, _ xtools.RoomVersion, eventNIDs []types.EventNID) ([]types.Event, error) {
	if u.roomInfo == nil {
