...
type StateResolutionStorage interface {
	...
	Events(ctx context.Context, roomVersion xtools.RoomVersion, eventNIDs []types.EventNID) ([]types.Event, error)
...
func (v *StateResolution) calculateStateAfterManyEvents(
	ctx context.Context, roomVersion xtools.RoomVersion,
	prevStates []types.StateAtEvent,
...
func (v *StateResolution) resolveConflicts(
	ctx context.Context, version xtools.RoomVersion,
...
func (v *StateResolution) resolveConflictsV1(
	...
	resolvedEvents := xtools.ResolveStateConflicts(conflictedEvents, authEvents, func(roomID spec.RoomID, senderID spec.SenderID) (*spec.UserID, error) {
...
func (l *authEventLoader) loadAuthEvents(
	ctx context.Context, roomInfo *types.RoomInfo, event xtools.PDU, eventMap map[string]types.Event,
) ([]xtools.PDU, map[string]types.StateEntry, error) {
	l.Lock()
	defer l.Unlock()
