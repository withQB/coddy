...
import (
	...
	asAPI "github.com/withqb/coddy/appservice/api"
...
type RestrictedJoinAPI interface {
	CurrentStateEvent(ctx context.Context, roomID spec.RoomID, eventType string, stateKey string) (xtools.PDU, error)
	InvitePending(ctx context.Context, roomID spec.RoomID, senderID spec.SenderID) (bool, error)
	RestrictedRoomJoinInfo(ctx context.Context, roomID spec.RoomID, senderID spec.SenderID, localServerName spec.ServerName) (*xtools.RestrictedRoomJoinInfo, error)
	...
	LocallyJoinedUsers(ctx context.Context, roomVersion xtools.RoomVersion, roomNID types.RoomNID) ([]xtools.PDU, error)
}

type DefaultRoomVersionAPI interface {
	// Returns the default room version used.
	DefaultRoomVersion() xtools.RoomVersion
}
...
type RoomserverInternalAPI interface {
	...
	SetFederationAPI(fsAPI fsAPI.RoomserverFederationAPI, keyRing *xtools.KeyRing)
...
type QueryMembershipAPI interface {
	...
	QueryRoomVersionForRoom(ctx context.Context, roomID string) (xtools.RoomVersion, error)
...
type ClientRoomserverAPI interface {
	...
	PerformCreateRoom(ctx context.Context, userID spec.UserID, roomID spec.RoomID, createRequest *PerformCreateRoomRequest) (string, *xutil.JSONResponse)
	// PerformRoomUpgrade upgrades a room to a newer version
	PerformRoomUpgrade(ctx context.Context, roomID string, userID spec.UserID, roomVersion xtools.RoomVersion) (newRoomID string, err error)
