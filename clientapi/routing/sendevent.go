...
func SendEvent(
	...
	if roomVersion == xtools.RoomVersionPseudoIDs && stateKey != nil {
	...
	if roomVersion == xtools.RoomVersionPseudoIDs && eventType == spec.MRoomPowerLevels {
...
func stateEqual(ctx context.Context, rsAPI api.ClientRoomserverAPI, eventType, stateKey, roomID string, newContent map[string]interface{}) *xutil.JSONResponse {
...
func generateSendEvent(
	...
	if err = xtools.Allowed(e.PDU, &provider, func(roomID spec.RoomID, senderID spec.SenderID) (*spec.UserID, error) {
