...
func (u *UserInteractive) challenge(sessionID string) *xutil.JSONResponse {
	u.RLock()
...
func (u *UserInteractive) NewSession() *xutil.JSONResponse {
...
func (u *UserInteractive) ResponseWithChallenge(sessionID string, response interface{}) *xutil.JSONResponse {
